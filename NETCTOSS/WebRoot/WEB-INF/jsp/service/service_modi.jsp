...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">
            ...
            <s:form action="serviceupdate" method="post" theme="simple" cssClass="main_form" id="serviceup">
                <!--必填项-->
                ...
                <div class="input_info">
                		<s:select  name="service.cost_id" list="cost" listKey="id" listValue="name" cssClass="width150"></s:select>
