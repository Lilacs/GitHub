...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function deleteAccount(id) {
                ...
                if(r){
                		...
                		window.location = 'servicedelete?id='.concat(id);
                }
            ...
            function setState1(id) {
                ...
                if(r){
                		document.getElementById("operate_result_info").style.display = "block";
                		window.location = 'servicepause?id='.concat(id);
                }
            ...
            function setState2(id) {
                ...
                if(r){
                		document.getElementById("operate_result_info").style.display = "block";
                		window.location = 'serviceopen?id='.concat(id);
                }
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">
            <s:form action="serall" method="post" theme="simple" id="serall-c">
                <!--查询-->
                <div class="search_add">                        
                    <div>OS 账号：<s:textfield name="osName" cssClass="width100 text_search" id="check1"></s:textfield></div>                            
                    <div>服务器 IP：<s:textfield name="unitHost" cssClass="width100 text_search" id="check2"></s:textfield></div>
                    <div>身份证：<s:textfield name="idCard" maxLength="18" cssClass="text_search" id="check3"></s:textfield></div>
                    <div>状态：
                    ...
                    <input type="button" value="增加" class="btn_add" onclick="location.href='serviceaddview';" />
                </div>  
                <!--删除的操作提示-->
                ...
                <div id="data">            
                    ...
                    <tr>
                        <td><a href="servicedetail?id=${service.id }" title="查看明细">${service.id }</a></td>
                        ...
                        <s:if test="#service.status != 2 ">
                            <input type="button" value="修改" class="btn_modify" onclick="location.href='servicemodi?id=${service.id }';" />
                        </s:if>
                        <s:if test="#service.status != 2 ">
