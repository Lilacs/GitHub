    ...
    <body>
        ...
        <div id="main">            
            <form action="" method="" class="main_form">
                ...
                <div class="input_info"><s:textfield name="account.real_name" readonly="true" cssClass="readonly"></s:textfield></div>
                <div class="text_info clearfix"><span>身份证：</span></div>
                <div class="input_info">
                    <s:textfield name="account.idcard_no"  readonly="true" id="idcard-c"></s:textfield></div>
                <div class="text_info clearfix"><span>登录账号：</span></div>
                <div class="input_info">
                    <s:textfield name="account.login_name"  readonly="true"></s:textfield>
                </div>                   
                ...
                <div class="input_info"><s:textfield name="account.recommender_id"></s:textfield></div>
                ...
                <div class="input_info"><input type="text" value="<s:date name="account.pause_date" format="yyyy-MM-dd"/>" readonly="readonly"></div>
                <div class="text_info clearfix"><span>上次登录时间：</span></div>
                <div class="input_info"><input type="text" value="<s:date name="account.last_login_time" format="yyyy-MM-dd"/>" readonly="readonly"></div>
                ...
                <div class="button_info clearfix">
                    <input type="button" value="返回" class="btn_save" onclick="location.href='accall';" />
                </div>
            </form>  
        </div>
        <!--主要区域结束-->
