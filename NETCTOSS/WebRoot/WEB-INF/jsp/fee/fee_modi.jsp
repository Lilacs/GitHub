...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function feeTypeChange(type) {
             ...
             function decide2(){
				var flag = false;
				var file = document.getElementById("check_name2").value;
				var file2 = document.getElementById("check_descr2").value;
				if(file == "" || file2 == ""){
					document.getElementById("someerror").innerHTML = "检查填写的数据!";
					return flag;
				}else{
					flag = true;
					return flag;
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="update_cost" method="post" class="main_form">
                <div class="text_info clearfix"><span>资费ID：</span></div>
                <div class="input_info"> <s:textfield name="cost.id" readonly="true" cssClass="readonly"></s:textfield></div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <s:textfield name="cost.name" cssClass="width300" id="check_name2"></s:textfield>
