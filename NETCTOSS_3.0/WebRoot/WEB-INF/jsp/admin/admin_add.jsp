...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <s:form action="adminowillLoggertoadd" method="post" cssClass="main_form" theme="simple" id="operate_create">
                    ...
                    <div class="input_info">
                        <s:textfield name="adminInfo.adminCode"></s:textfield>
                        <span class="required">*</span>
                        <div class="validate_msg_long"></div>
                    </div>
                    <div class="text_info clearfix"><span>密码：</span></div>
                    <div class="input_info">
                       	<s:password name="adminInfo.password"></s:password>
                        <span class="required">*</span>
                        <div class="validate_msg_long"></div>
                    </div>
                    ...
                    <div class="input_info">
                        <s:textfield name="adminInfo.telephone" cssClass="width200"></s:textfield>
                        <span class="required">*</span>
                    ...
                    <div class="input_info_high">
                        ...
                        <ul>
                            <s:checkboxlist  name="num" list="roleInfos" listKey="id" listValue="name"  theme="verticalcheckbox"></s:checkboxlist>
 						</ul>
 					</div>
                        <span class="required">*</span>
