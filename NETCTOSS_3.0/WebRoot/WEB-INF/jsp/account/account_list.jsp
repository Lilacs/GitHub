        ...
        <script language="javascript" type="text/javascript">
            ...
            function setState(status,id) {
            		if(status == 0){
            			 ...
            			 if(r){
            			 	document.getElementById("operate_result_info").style.display = "block";
            			 	window.location = 'accountowillLoggertopause?id='.concat(id);
            			 }
            		}
            		if(status == 1){
            			 ...
            			 if(r){
            			 	document.getElementById("operate_result_info").style.display = "block";
            			 	window.location = 'accountowillLoggertoopen?id='.concat(id);
            			 }
                    ...
                    <tr>
                        ...
                        <s:if test="#account.status == 1">
                         ...
                         <s:if test="#account.status != 2">
                            ...
                            <input type="button" value="删除" class="btn_delete" onclick="window.location='accountowillLoggertodelete?id=${account.id }'" />
                         </s:if>  
                        </td>
                    </tr>       
                    </s:iterator>       
