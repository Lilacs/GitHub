        ...
        <script language="javascript" type="text/javascript">
            ...
            function deleteAccount(id) {
                ...
                if(r){
                		...
                		window.location = 'serviceowillLoggertodelete?id='.concat(id);
                }
            ...
            function setState1(id) {
                ...
                if(r){
                		document.getElementById("operate_result_info").style.display = "block";
                		window.location = 'serviceowillLoggertopause?id='.concat(id);
                }
            ...
            function setState2(id) {
                ...
                if(r){
                		document.getElementById("operate_result_info").style.display = "block";
                		window.location = 'serviceowillLoggertoopen?id='.concat(id);
                }
